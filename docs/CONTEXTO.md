...
Processo (o mesmo do heroi anterior): laco cosido com xfade de 0,8s (corpo comeca em 0,8s e o fim funde com a cabeca 0..0,8s, primeiro e ultimo fotograma iguais), H.264 yuv420p +faststart sem audio. `hero-lg.mp4` 1920x1080 CRF21 (4,7 MB, 4,29s) e `hero-vert.mp4` 720x1280 CRF23 (1,4 MB), recorte `crop=607:1080:880:0` escolhido para apanhar o logotipo da carrinha ao inicio e os trabalhadores no fim. Posters webp por cwebp (o ffmpeg do brew nao tem libwebp). Nada mudou no codigo: os nomes dos ficheiros sao os mesmos e o `video-backdrop` fica como esta.
