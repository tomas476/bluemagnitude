...
2. **O sol encostava as letras em telemovel.** A 390px o titulo ocupa quase a largura toda; abaixo de 48rem o sol passou a `right: -1.25rem` e `width: 7.5rem`. Em desktop nao mudou.
